...
# Initialize AxiDraw
ad = axidraw.AxiDraw()
ad.options.units = 'mm'  # Set units to millimeters
...
def draw_random_line_and_home():
    with ad_lock:
        # Adjusted drawing area dimensions for A3 size (297mm x 420mm)
        x1 = random.uniform(400, 520)
        y1 = random.uniform(200, 397)
        x2 = random.uniform(400, 520)
        y2 = random.uniform(200, 397)
        ad.moveto(x1, y1)
        ad.lineto(x2, y2)
